...
while True:
    ...
    pads, dic_author_current_operations_per_pad = operation_builder.build_operations_from_elem_ops(
    ...
    for pad_name in pads:
        ...
        pad.create_paragraphs_from_ops(new_list_of_elem_ops_per_pad_sorted)
